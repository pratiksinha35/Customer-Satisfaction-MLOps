...
class MlFlowDeploymentLoaderStepParameters(BaseParameters):
    '''MLflow deployment getting parameters
    ...
    Attributes:
        ...
        running: when this flag is set, the step only returns running service
        model_name: the name of the model being deployed  
    '''
    pipeline_name: str
    step_name: str
    running: bool = True
...
def prediction_service_loader(
    ...
    '''Get the prediction service started by the deployer
